...
import com.ravneet.myapplication.HomeActivity;
import com.ravneet.myapplication.MainActivity;
import com.ravneet.myapplication.R;
import com.ravneet.myapplication.model.User;
        ...
        auth.createUserWithEmailAndPassword(user.email, user.password)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isComplete()) {
//                    Toast.makeText(RegistrationActivity.this,user.name+ "Registered Successsfully",Toast.LENGTH_LONG).show();
